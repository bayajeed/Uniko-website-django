...
STATIC_URL = '/static/'
STATICFILES_DIRS = [BASE_DIR / 'static']  # যেখানে static ফাইল রাখা হবে (development)
STATIC_ROOT = BASE_DIR / 'staticfiles'    # collectstatic এর জন্য (production)
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')

# Media files (Uploaded content for users)
MEDIA_URL = '/media/'
